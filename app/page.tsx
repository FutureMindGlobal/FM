...
type SitePopup={id:string;title:string;body_text:string|null;button_text:string|null;button_url:string|null;youtube_url?:string|null;open_new_tab?:boolean;frequency:string;position:string;audience:string;media_assets:PopupMedia|null};
